...
<html lang="en">
<head>
    <title>Carrito de Compras My Vending</title>
    <meta charset="utf-8">
...
<div class="panel-body">
    ...
    <tfoot>
        <tr>
            ...
            <td><a href="Pagos.php?a=<?php echo $id_user?>" class="btn btn-success btn-block">Pagar <i class="glyphicon glyphicon-menu-right"></i></a></td>
            <?php } ?>
        </tr>
    </tfoot>
    </table>
