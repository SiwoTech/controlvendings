...
<html>
    ...
    <div id="wb_header">
                    ...
                    <div id="headerMenu" class="headerMenu" style="width:100%;height:auto !important;">
                        <div class="container">
                           ...
                           <button class="btn btn-danger btn-lg" id="btn-success3" style="position:absolute; top:180%; left:85%; border-radius: 50px; z-index:35;">			
								<a href="https://cleanworkorange.com/qn/vending/datas/index.html"><div id="wb_txtsalir" style="color:white">Salir</div></a>
							</button>
                        </div>
                    </div>
                </div>
		...
		<!-- Boton para descargar App -->
			<button class="btn btn-secondary btn-lg" id="btn-success2" style="position:relative; left:10%; border-radius: 20px; z-index:35;">			
			    <a href="https://cleanworkorange.com/qn/vending/datas/app/MyVendingOrange.apk"><div id="wb_txtinfo">Descargar App</div></a>
		    </button>
		    <button class="btn btn-secondary btn-lg" id="btn-success2" style="position:relative; left:10%; border-radius: 20px; z-index:35;">			
			    <a href="https://cleanworkorange.com/qn/vending/datas/app/VendingApp.apk"><div id="wb_txtinfo">Descargar Calibrador</div></a>
		    </button>
		
		<!-- Boton para pedidos -->
			<button class="btn btn-secondary btn-lg" id="btn-success2" style="position:absolute; left:75%; border-radius: 20px; z-index:35;">			
			    <a href="https://cleanworkorange.com/qn/vending/datas/pedidos/index.php"><div id="wb_txtinfo">Pedidos</div></a>
		    </button>
		...
		<?php if($level>2){?>
			...
			<form class="form-inline" method="POST" action="">
				...
				<button class="btn btn-primary" name="search"><span class="glyphicon glyphicon-search"></span></button> <a href="control.php" type="button" class="btn btn-success"><span class = "glyphicon glyphicon-refresh"><span></a>
			</form>
		    <div style="width:80%">   
				<!--<div id="buscador"></div>-->
